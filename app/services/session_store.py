...
class DynamoDBSessionStore:
    ...
    def update_session(self, session_id: str, user_data: Dict[str, Any]) -> bool:
        ...
        try:
            self.table.update_item(
                ...
                ExpressionAttributeValues={":data": json.dumps(user_data)},
            )
    ...
    def extend_session(self, session_id: str, ttl_seconds: int = 3600) -> bool:
        ...
        try:
            self.table.update_item(
                Key={"session_id": session_id}, UpdateExpression="SET ttl = :ttl", ExpressionAttributeValues={":ttl": new_ttl}
            )
...
class InMemorySessionStore:
    ...
    def create_session(self, user_data: Dict[str, Any], ttl_seconds: int = 3600) -> str:
        session_id = secrets.token_urlsafe(32)
        self.sessions[session_id] = {"user_data": user_data, "expires_at": time.time() + ttl_seconds}
        return session_id
